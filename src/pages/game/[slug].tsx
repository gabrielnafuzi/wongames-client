...
export const getStaticProps: GetStaticPropsGame = async () => {
  ...
  return {
    props: {
      ...
      gameInfo: {
        ...
        price: '59.00',
        description:
          'Cyberpunk 2077 is a first-person shooter video game developed by CD Projekt and published by CD Projekt Red. It is the first game in the Cyberpunk series and was released for Microsoft Windows, PlayStation 4, and Xbox One on October 25, 2020.',
      },
      gallery: galleryMock,
